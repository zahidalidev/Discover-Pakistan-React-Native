...
class AboutDiscoverPakistan extends React.Component {
  Loader = true;
  _isMounted = false;
  constructor(props) {
    super(props);
  ...
  async UNSAFE_componentWillMount() {
    ...
    if (this._isMounted) {
      this.setStateObj({ selectedMela: melaList[0] });
                ...
                <Row style={{ flexDirection: "column", marginBottom: hp("1") }}>
                      ...
                      {melaList.map((item, i) => {
                        return (
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              this.setStateObj({ selectedMela: item });
                            }}
                          >
                            <Text
                              style={{
                  ...
                  >
                    ...
                    >
                      ...
                      Eastern and modern-day Western popular music
                      influences.With multiple informations, a distinctive
                      Pakistani sound has emerged.
                    </Text>
                  </ImageBackground>
