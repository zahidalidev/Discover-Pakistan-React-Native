...
const bannerImg = './../../Assets/disclaimer.png';
                        ...
                        return(<>
                            <Row style={{ height:hp('25') }}>
                                <Row style={styles.bannerImg}>
                                    <Image source={require(bannerImg)} style={{ width:wp('36'), height:null }} />
                                </Row>
                ...
                <Row style={styles.contents}>
                    <ScrollView>
                        <Row style={styles.screenTitleRow}>
                            ...
                            <Text style={styles.screenTitle}>DISCLAIMER</Text>
                        </Row>
                        ...
                        <Row style={styles.mainRow}>
                            ...
                            <Text style={styles.simpleText}>
                            This website ensures use of your data in accordance with our privacy policy and your use of this site is subject to the below mentioned terms and conditions. These Terms constitute a legally binding agreement between you and Discover Pakistan for your usage of the Site and the services that allows for the distribution and reception of video, audio, and other content. Do not use the site if you do not agree with any of the terms contained herein:
                            </Text>
                            <Text style={styles.simpleText}>
                            ...
                            <Text style={styles.simpleText}>
                            ou can also cut and paste certain code distinctly made available to you through the website, forward it to your friends, so that they can view our content contained therein, and/or if, they so desire, enables them to embed the forwarded piece of code on their own personal social media or re-forward it to their own friends.
                            </Text>
                            <Text style={styles.simpleText}>
                            ...
                            <Text style={styles.simpleText}>
                                I. By allowing you to download the Software, Discover Pakistan does not transfer title of that software to you (i.e., you own the medium on which the software is recorded, but the software's owner will retain its full and complete title.
                            </Text>
                            <Text style={styles.simpleText}>
                                II. You shall not copy, modify, adapt, translate into any language, distribute, or create derivative works based on that software without the prior written consent of Discover Pakistan.
                            </Text>
                            <Text style={styles.simpleText}>
                            ...
                            <Text style={styles.simpleText}>
                                V. Because the laws and regulations of Pakistan restrict the export and re-export of commodities and technical data of Pakistani origin, including the software(s), you will not export or re-export the software in any form in violation of the laws of Pakistan or any foreign jurisdiction.
                            </Text>
                            <Text style={styles.simpleText}>
                            ...
                            <Text style={styles.simpleText}>
                            A user/visitor/reader will use the site and the licenses at all times in compliance with the aforementioned terms. Miscellaneous Discover Pakistan reserves the right to modify these terms and Conditions at any time. The conditions become effective as published on this site. Should you have any query you can contact us at the below mention address.
                            </Text>
